  ...
  return (
    <section className="section w-full max-md:px-2 flex justify-center items-center max-md:text-center relative">
      ...
      <div className="w-full px-16 max-w-[1287px] border-b pb-16 gap-4 flex justify-between items-center flex-wrap">
        <div className="flex flex-col items-start gap-9 max-md:items-center">
        ...
        <div className="flex flex-col items-start gap-[27px]">
          ...
          >
            <Input
              ...
              className="rounded-full border border-[#444] bg-inherit w-[317px] max-md:w-full min-h-[58px] px-6 py-[17px] placeholder:text-[16px] placeholder:text-white"
              required
            />
            <button
              className="cursor-pointer [border:none] py-2.5 px-3.5 bg-[transparent] self-stretch rounded-11xl [background:linear-gradient(0deg,_#5e3aee,_#be33ff)] shadow-[0px_14px_34px_rgba(15,_10,_22,_0.5),_0px_-6px_8px_rgba(255,_255,_255,_0.35)_inset,_0px_14px_14px_rgba(255,_255,_255,_0.25)_inset] flex flex-row items-center justify-center box-border whitespace-nowrap rounded-full transition duration-300 ease-in-out hover:bg-opacity-70 hover:scale-105 max-md:w-full min-w-[170px] min-h-[58px]"
              type="submit"
            >
